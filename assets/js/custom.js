...
$(function() {
    ...
    if (fullPageScroll.length)
        var anchorsList = ['home-section', 'timeline-section', 'artist-section', 'sponsor-section', 'gallery-section', 'ticket-section', 'askus-section', 'contact-section', 'reach-section', 'footer-section'];
    else if (normalPageScroll.length)
        var anchorsList = ['home-section', 'timeline-section', 'artist-section', 'sponsor-section', 'gallery-section', 'ticket-section', 'socail-section', 'askus-section', 'contact-section', 'reach-section', 'footer-section'];
    else
    ...
    if ($("#twitter-container").length) {
        twttr.ready(function(twttr) {
            ...
            twttr.widgets.createGridFromCollection(
                "123456789000000000", //Your twitter id here
